...
export function ImageGallery() {
    return (
        <Carousel showArrows showThumbs={false} infiniteLoop={true}>
            <div className="w-full flex flex-row justify-center items-center h-130 gap-x-8 px-30 bg-[url(/src/assets/hero-bg.png)] bg-green-900/60 bg-blend-darken">
                ...
                <div className="h-70 w-70 flex justify-center items-center">
                    <img src="./src/assets/video-thumbnail-img.png" />
